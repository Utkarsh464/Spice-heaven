  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ fontFamily: "var(--serif)", fontSize: 22, fontWeight: 500, color: "var(--gold)", letterSpacing: "0.04em", lineHeight: 1 }}>
            Spice Haven
          </div>
          <div style={{ fontFamily: "var(--sans)", fontSize: 8, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--warm)", marginTop: 3 }}>
            Fine Indian Cuisine
          </div>
        </button>
        ...
        <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: 40 }}>
          {NAV_ITEMS.map((n) => (
            <button
              ...
              style={{
                ...
                color: page === n ? "var(--gold)" : "var(--warm)",
                transition: "color .3s",
                padding: "4px 0",
              }}
          ...
          <Btn onClick={() => navigate("Booking")} style={{ padding: "10px 28px", fontSize: 10 }}>
            Reserve
          </Btn>
        </div>
      ...
      {open && (
        ...
        >
          {NAV_ITEMS.map((n) => (
            <button
              key={n}
              onClick={() => { navigate(n); setOpen(false); }}
              style={{
                background: "none",
                border: "none",
                cursor: "pointer",
                ...
                fontWeight: 400,
                color: page === n ? "var(--gold)" : "var(--cream)",
