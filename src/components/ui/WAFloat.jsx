...
/**
 * WAFloat — Fixed floating WhatsApp button (bottom-right).
  ...
  return (
    <a
      ...
      style={{
        ...
        transition: "all .4s var(--ease-spring), box-shadow .3s",
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.transform = "scale(1.12)";
        e.currentTarget.style.boxShadow = "0 12px 40px rgba(37,211,102,.5)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = "scale(1)";
        e.currentTarget.style.boxShadow = "0 8px 32px rgba(37,211,102,.35)";
      }}
    >
