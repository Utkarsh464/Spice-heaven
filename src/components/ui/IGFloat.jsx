...
/**
 * IGFloat — Fixed floating Instagram button (bottom-right).
 * Slides in 3s after load. Replaces the WhatsApp float.
 *
 * Uses Instagram's official brand gradient:
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontFamily: "var(--sans)", fontSize: 11, color: "var(--cream)", letterSpacing: "0.05em" }}>
          DM us on Instagram
        </div>
        <div style={{ fontFamily: "var(--sans)", fontSize: 10, color: "var(--muted)", marginTop: 2 }}>
          @webgrowth.in
        </div>
      </div>
